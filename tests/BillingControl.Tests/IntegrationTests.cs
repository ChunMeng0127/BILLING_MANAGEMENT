...
public partial class IntegrationTests
{
    ...
    public async Task WeeklyProgressReportsEnforceWeeksUniquenessConcurrencyAndEntityScope()
    {
        ...
        var workerPage = await workerClient.GetStringAsync("/Progress"); Assert.Contains("Progress Customer", workerPage); Assert.Contains("Progress Service", workerPage); Assert.Contains("Service Period", workerPage); Assert.Contains("01 Jan 2026 – 31 Jan 2026", workerPage); Assert.Contains("Submitted", workerPage); Assert.Contains("Update progress", workerPage); Assert.Contains("First submitted", workerPage); Assert.Contains("Updates this week", workerPage); Assert.DoesNotContain("Progress Worker B", workerPage); Assert.DoesNotContain("LCM gross", workerPage);
