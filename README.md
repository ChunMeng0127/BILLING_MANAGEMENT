...
7. Record worker payments, allocating positive amounts to one or more outstanding assignments for that worker. Entitlement and cash paid remain separate.
