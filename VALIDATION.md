...
- JavaScript tests: **6 passed, 0 failed**. They cover per-flow eligibility, partial allocations, input maximums, stale-value clearing, eligible row counts, the all-allocated empty state and external initialization under the production Content Security Policy.
