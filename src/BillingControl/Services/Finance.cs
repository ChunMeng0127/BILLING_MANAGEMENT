...
public static class Finance
{
    ...
    public static string Label(object value) => value switch
    {
        ...
        DocumentRequirementWave.StartWork => "Start Work",
        DocumentRequirementWave.Normal => "Normal",
        DocumentRequirementWave.Later => "Later",
        DocumentRequirementWave.Optional => "Optional",
        DocumentRequestStatus.ReadyToSend => "Ready to Send",
        DocumentRequestStatus.PartiallyReceived => "Partially Received",
        DocumentRequestStatus.Requested => "Requested",
        DocumentRequestStatus.Complete => "Complete",
        DocumentRequestStatus.Paused => "Paused",
        DocumentRequestStatus.Cancelled => "Cancelled",
        DocumentRequestStatus.Superseded => "Superseded",
        DocumentRequestItemStatus.NotRequired => "Not Required",
        DocumentRequestItemStatus.PartiallyReceived => "Partially Received",
        DocumentRequestItemStatus.Requested => "Requested",
        DocumentRequestItemStatus.Received => "Received",
        DocumentRequestItemStatus.Waived => "Waived",
        ContactWhatsAppConsentState.Unknown => "Unknown",
        ContactWhatsAppConsentState.OptedIn => "Opted In",
        ContactWhatsAppConsentState.DoNotWhatsApp => "Do Not WhatsApp",
