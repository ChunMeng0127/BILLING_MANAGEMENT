...
- Phase 9A is promoted to stable as recorded above. Phase 9B is promoted to stable with source, promotion-tree, CI and validation facts recorded above. Phase 9C staff management UI implementation is in progress on isolated `codex/phase9c-conversation-ui`; technical review and manual staff UI acceptance remain outstanding, and Phase 9 is not complete.
...
- Phase 9C validation is being completed on isolated branch `codex/phase9c-conversation-ui`. Technical review and manual staff UI acceptance remain pending; Phase 9 is not fully complete. Phase 10, provider network calls/sending, webhook/inbox/outbox/background work, SharePoint/ReceivedDocument handling, follow-up/AI, financial mutations and WorkItem/document-request workflow mutations remain out of scope.
