...
- Phase 9B implementation is in progress on the isolated `codex/phase9b-conversation-service` branch. It is limited to the scoped `WhatsAppConversationService`, provider-neutral read models, `Program.cs` registration, audited participant/version invalidation, explicit Engagement-scope approval/reapproval/revocation, conservative conversation lifecycle behavior, and focused PostgreSQL service/concurrency/boundary tests. No migration, model snapshot, Phase 9C UI, Phase 10 request/send behavior, provider call, or financial/workflow mutation is included.
...
- Phase 9A is promoted to stable as recorded above. Phase 9B implementation is isolated on `codex/phase9b-conversation-service` and awaits final validation/review. Phase 9C remains deferred; Phase 9 is not complete.
...
**Phase 9A is promoted to stable at `b0d70280e40187d1bb50dc3bc61d8cf105e9b6c1` from approved SHA `28948bc3c62b07f379532d2503feeac736d290d8`. Phase 9B is implemented on isolated `codex/phase9b-conversation-service` pending final validation/review; Phase 9C remains deferred. Phase 9 is not complete.**
